 ...
 */
public class YuvRender implements XYEGLSurfaceView.XYGLRender {
...
//    private int u_matrix;
    ...
    public YuvRender(Context context) {
        ...
        xyYuvFboRender = new XYYuvFboRender(context);
...
//        Matrix.setIdentityM(matrix, 0);
    ...
    public void onSurfaceCreated() {
        xyYuvFboRender.onCreate();
        String vertexShader = XYShaderUtil.getRawResource(context, R.raw.vertex_shader_yuv);
        String fragmentShader = XYShaderUtil.getRawResource(context, R.raw.fragment_shader_yuv);
...
//            GLES20.glUniformMatrix4fv(u_matrix, 1, false, matrix, 0);
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);
        xyYuvFboRender.onDraw(textureid);
